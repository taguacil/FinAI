...
class TransactionLoggerAdapter(logging.LoggerAdapter):
    ...
    def __init__(self, logger: logging.Logger, transaction_id: str, portfolio_id: str = None):
...
def log_portfolio_change(portfolio_id: str, change_type: str, details: str):
    ...
    logger = PortfolioLoggerAdapter(
        logging.getLogger('src.portfolio'), 
        portfolio_id
    )
...
def log_metric_calculation(metric_name: str, portfolio_id: str, result: dict):
    ...
    logger = PortfolioLoggerAdapter(
        logging.getLogger('src.utils.metrics'), 
        portfolio_id
    )
...
def log_data_provider_error(provider: str, operation: str, symbol: str, error: Exception):
