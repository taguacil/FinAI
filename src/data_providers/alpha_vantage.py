...
from .base import BaseDataProvider, PriceData, InstrumentInfo, DataProviderError, RateLimitError
...
class AlphaVantageProvider(BaseDataProvider):
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.api_key = api_key or os.getenv('ALPHA_VANTAGE_API_KEY', 'ALPHA_VANTAGE_API_KEY_PLACEHOLDER')
        ...
        try:
            ...
            for date_str, price_info in time_series.items():
                try:
                    ...
                    print(f"Error processing price data for {symbol} on {date_str}: {e}")
                    continue
        ...
        try:
            ...
            if overview_data and overview_data.get('Symbol'):
                ...
                return InstrumentInfo(
                    ...
                    market_cap=Decimal(str(overview['MarketCapitalization'])) if overview.get('MarketCapitalization') and overview['MarketCapitalization'] != 'None' else None,
