...
class PortfolioManager:
    ...
    def __init__(
        ...
        self._instrument_resolver = InstrumentResolver(self.data_manager)
    ...
    def _discover_instrument_info(
        ...
        """Delegate to InstrumentResolver for instrument discovery."""
        return self._instrument_resolver.discover_instrument_info(
            symbol, isin, currency, notes, instrument_type
        )
